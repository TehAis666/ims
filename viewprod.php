...
$sql = "SELECT p.productid, p.productname, p.productimage, p.quantityinstock, c.categoryname
        FROM product p
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<tr>
                            <td scope='row'>$no</td>
                            <td>$productName</td>
                            <td><img src='imageproduct/$productImage' alt='$productName' style='width: 100px; height: auto;'></td>
                            <td>$categoryName</td>
                            <td>$quantityInStock</td>
                            <td>
                                <a href='editproduct.php?id=$productID' class='btn btn-warning btn-sm'>Edit</a>
                                <a href='deleteproduct.php?id=$productID' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this product?\")'>Delete</a>
                            </td>
                        </tr>";
