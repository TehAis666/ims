              ...
              <table class="table table-hover datatable">
                ...
                if ($result_customers->num_rows > 0) {
                    ...
                    while($customer = $result_customers->fetch_assoc()) {
                        ...
                        echo "<td>" . htmlspecialchars($customer['customercontact']) . "</td>";
                        echo "<td>" . htmlspecialchars($customer['customeraddress']) . "</td>";
                        echo "<td>" . htmlspecialchars($customer['customerpostalcode']) . "</td>";
                        echo "<td>" . htmlspecialchars($customer['customerstate']) . "</td>";
                        echo "<td><a href='editcustomer.php?id=" . htmlspecialchars($customer['customerid']) . "' class='btn btn-warning btn-sm'>Edit</a> ";
                        echo "</tr>";
                    }
                } else {
