...
// Query to join orders with products and customers without warranties
$withoutwarrantyquery = "
    SELECT 
        p.productname, 
        c.customername,
        c.customerstate, 
    ...
    FROM 
        ...
        LEFT JOIN warranty w ON o.orderid = w.orderid
    WHERE 
        w.warrantyid IS NULL
";
...
// Execute the query
$resultwithoutwarranty = $conn->query($withoutwarrantyquery);
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Order Not Yet Registered Warranty</h5>
              ...
              <table class="table table-hover datatable">
                ...
                <tbody>
                <?php if ($resultwithoutwarranty->num_rows > 0) : ?>
            <?php while ($row = $resultwithoutwarranty->fetch_assoc()) : ?>
                <?php
                ...
                <tr data-id="<?php echo $orderId; ?>"
                    ...
                    <td>
                        ...
                        <a href="#" class="warranty-link">
                            <button class="btn btn-success rounded-pill btn-sm">Warranty</button>
                        </a>
                    </td>
                </tr>
            <?php endwhile; ?>
